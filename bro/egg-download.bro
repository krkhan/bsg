...
export {
	...
	const tcymru_match_threshold = 1 &redef;
	const disguised_exe_threshold = 2 &redef;
}
...
function egg_record_expired(t: table[addr] of EggRecord, idx: any): interval
	...
	egg_download_info$src_ip= idx;
	local message = "";
	for (rec in t[idx]$ip_url_md5)
		{
...
global table_egg: table[addr] of EggRecord &create_expire=15mins &expire_func=egg_record_expired;
